...
[Serializable]
#endif
public partial class PkgCToS_CreateRoom : TBase
{
  ...
  public void Write(TProtocol oprot) {
    TStruct struc = new TStruct("PkgCToS_CreateRoom");
  ...
  public override string ToString() {
    StringBuilder sb = new StringBuilder("PkgCToS_CreateRoom(");
